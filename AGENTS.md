...
- 正式回答和过程摘要不得使用“图谱未提供”“知识库尚不支持”“知识库未提供”“未命中”“没有检索到”等系统视角措辞；待验证项统一改写成核验、小试、补充资料或专业复核建议。
- `product_development` 必须联查 KB5 名方与 KB4 单味替代关系；直接关系标注为“图谱直接证据”，按功效、人群、风味筛选的近似方只能标注为“系统推导的参考原型”。
